...
class msg:
    ...
    def msgclick(self):
        ...
        self.driver.find_element_by_id('com.dealuck.cyy:id/et_comment').send_keys(u'很是帅气')
        time.sleep(2)
        self.driver.find_element_by_id('com.dealuck.cyy:id/tv_send').click()
        time.sleep(2)    # 发送
        ...
        self.driver.find_element_by_id('com.dealuck.cyy:id/rl_comment').send_keys(u'666')
        time.sleep(2)
        self.driver.find_element_by_id('com.dealuck.cyy:id/tv_send').click()
        time.sleep(2)   # 发布评论
        self.driver.find_element_by_id('com.dealuck.cyy:id/ll_comment').send_keys(u'111')
        time.sleep(2)
        self.driver.find_element_by_id('com.dealuck.cyy:id/tv_send').click()
        ...
        if msg8 == '关注':
            ...
            time.sleep(2)
            msg9 = self.driver.find_element_by_xpath('/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.RelativeLayout[2]/android.support.v7.widget.RecyclerView/android.widget.RelativeLayout[1]/android.widget.TextView').text
            if msg9 == '已关注' or '互关注':
